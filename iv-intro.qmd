...
- Example: @angrist1991does study the effect of compulsory schooling laws in the US on returns to education (see fig.).
:::

::: {.column width="30%"}
[Path diagram: Effect of $X$ on $Y$ with OV]{.highlight .center}
```{mermaid}
%%| echo: false
flowchart TD
...
- Large sample properties of TSLS estimates
